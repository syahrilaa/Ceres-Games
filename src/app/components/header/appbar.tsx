...
import ChainsGameLogo from '@public/chainsgame.png'
...
export const AppBar = () => {
  ...
  return (
    <section className='fixed top-0 left-0 w-full h-16 px-4 md:px-6 lg:px-8 z-20'>
      <div className="h-full w-full flex flex-row items-center justify-between">
        <div className="flex gap-4 md:gap-6 lg:gap-8 items-center">
          <div>
            <Image src={ChainsGameLogo} alt="unogame-logo-2024" quality={30} priority={true} className='h-11 w-max' />
        ...
        <div className='flex justify-end gap-4'>
          ...
          <Link href='/account/signin' className='text-sm px-4 py-2.5 bg-blue-500 ring-1 ring-blue-500 text-white font-medium rounded-2xl'>
          ...
          <div className='lg:hidden block'>
            ...
            {openMenu && (
              <motion.div ref={containerMenu} initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className='h-max w-max fixed top-3 right-3 bg-white ring-1 ring-slate-200 rounded-2xl flex flex-col gap-3 shadow-lg z-50'>
                <NavigationLink />
