...
export const LanguageSelector = () => {
  ...
  return (
    <div className='relative h-max w-44'>
      <button onClick={handleOpenListLang} className='relative w-full flex items-center text-sm gap-2.5 text-slate-700 font-medium px-4 py-2.5 bg-transparent ring-1 ring-slate-200 rounded-2xl'>
